...
const internships = [
  {
    ...
    company: "IIT Ropar",
    duration: "Ongoing",
    desc: "Building production-grade full-stack applications using the MERN stack. Developing RESTful APIs with Node.js/Express, building responsive React frontends with state management, and designing MongoDB schemas for real-world use cases. Vishaka project was builded it a MERN+RAG project.",
  ...
  },
  {
    ...
    duration: "6 months",
    desc: "Developed responsive web applications using HTML/CSS, JavaScript, PHP, and MySQL. Built Online Bicycle Management System for HCLTech Chennai.",
